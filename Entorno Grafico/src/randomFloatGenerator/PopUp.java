...
public class PopUp extends JFrame {
	...
	public PopUp(String message) {
		...
		label_imgError.setIcon(new ImageIcon(PopUp.class.getResource("/img/iconoStop.png")));
		GroupLayout gl_contentPane = new GroupLayout(contentPane);
		gl_contentPane.setHorizontalGroup(
			gl_contentPane.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_contentPane.createSequentialGroup()
					.addContainerGap()
					.addComponent(label_imgError, GroupLayout.PREFERRED_SIZE, 94, Short.MAX_VALUE)
		...
		gl_contentPane.setVerticalGroup(
			gl_contentPane.createParallelGroup(Alignment.TRAILING)
				...
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addComponent(label_imgError, GroupLayout.PREFERRED_SIZE, 76, GroupLayout.PREFERRED_SIZE)
					.addGap(17))
		);

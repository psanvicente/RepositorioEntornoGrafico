...
/**
 * Documentado por Pablo Sánchez Sanviente Clase con la cual se muestra la
 * información general
 * 
 * @author vith21
 * @version 2.0
...
public class Info extends JDialog {
	...
	/**
	 * Panel que contiene componentes
	 */
	private final JPanel contentPanel = new JPanel();
	/**
	 * Botón utilizado para salir
	 */
	...
	public Info() {
		...
		label.setIcon(new ImageIcon(Info.class
